...
"openvt": "Sudo",
"opkg": "Sudo",
"pandoc": "File write, File read, SUID, Sudo",
...
def check_program(program):
    try:
        subprocess.check_call(["which", program], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        return True
    except subprocess.CalledProcessError:
        return False

print("Installed programs:")
installed_programs = [program for program in programs_info if check_program(program)]
for program in installed_programs:
    print(f"{program} --> {programs_info[program]} --> https://gtfobins.github.io/gtfobins/{program}/")
